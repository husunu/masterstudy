    ...
    <form id="pmpro_form" class="pmpro_form"
		...
		<?php } elseif ($current_user->ID && !$pmpro_review) { ?>
            ...
            <p id="pmpro_account_loggedin" class="message message-notice">
				<?php printf(__('You are logged in as <strong>%s</strong>. If you would like to use a different account for this membership, <a href="%s">log out now</a>.', 'masterstudy'), $current_user->user_login, wp_logout_url()); ?>
            </p>
		<?php } ?>
